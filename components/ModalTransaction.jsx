...
export default function ModalTransaction({
  ...
  return (
    <div>
      <div className="fixed left-0 top-0 flex z-10 h-full w-full items-center justify-center bg-black bg-opacity-50 py-10">
          ...
          <div className="w-full">
            <div className="relative bg-white rounded-lg shadow ">
              ...
              <div className="p-4 md:p-5">
                <ol
                  className={`relative border-s border-gray-200  ms-3.5 mb-4 md:mb-5 ${
                ...
                >
                  <li className="mb-10 ms-8">
                    {isSuccess ? (
                      ...
                      <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-3.5 ring-8 ring-white">
                        {isError ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <time className=" mb-3 text-sm font-normal leading-none text-gray-500 ">
                      {isLoading &&
                  ...
                  <li className="mb-10 ms-8">
                    ...
                    <h3 className="mb-1 text-lg font-semibold text-gray-900 ">
                      {isSuccess && "Transaction in progress"}
                    </h3>
                    <p className=" mb-3 text-sm text-red-500 font-normal leading-none ">
                      {isSuccess &&
                    ...
                    {isSuccess && (
                      ...
                      >
                        ...
                        <svg
                          ...
                          strokeWidth={1.5}
                          stroke="currentColor"
                          className="ml-2 w-4 h-4 font-extrabold"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
